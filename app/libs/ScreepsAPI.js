/*
* This file has been created by ags131 and edited by iKlem.
*/
...
class ScreepsAPI extends EventEmitter {
  ...
  constructor (opts) {
    ...
    this.opts = opts
    this.prefix = opts.host // || opts.ptr ? 'https://screeps.com/ptr' : 'https://screeps.com'
  ...
  req (method, path, body, cb) {
    ...
    return new Promise((resolve, reject) => {
      ...
      request({
        ...
        url: `http://${this.prefix}:${this.port}${path}`,
        json: true,
        method,
        headers: {
